...
<html>
	...
	<body>
		...
		<s:form id="addForm" action="addPermission" namespace="/security/role" method="post" onsubmit="return doSave();">
		<table class="profile">
			<tbody>
				<tr>
				...
				<tr>
					...
					<td>
						...
						<li>
							...
							<ul>
							<s:set name="sortedList" value="@com.google.code.lightssh.project.security.entity.Navigation@sort(#request.nav_list)"/>
		...
		<p class="submit">
			<input type="submit" class="action save" name="Submit" value="保存权限"/>
		</p>
		</s:form>
	</body>
</html>