...
<body class="public">
	...
	<s:if test="account != null ">
		<p>
			<div class="secondary">
				已向 <strong><s:property value="account.email"/></strong>发送了一封电子邮件，其中含有与该地址关联的用户名。
				<br/>
				收到此邮件后，你可用使用该用户名进行登录。记不起密码可以链接<a href="<s:url value="/security/recovery/forgotpassword.do"/>">忘记密码</a>。
			</div>
			
			<div class="secondary">
				<br/>
				如果<strong> <s:property value="account.email"/></strong>不是您的邮箱地址，您就不会收到电子邮件。
			</div>
		</p>
	</s:if>
	<s:else>
